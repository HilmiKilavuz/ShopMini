...
fun OrderSuccessScreen(
    ...
    BackHandler {
        onNavigateToHome()  // geri yerine Home'a git
    }
    Box(
        modifier = Modifier
            .fillMaxSize()
            ...
            Button(
                ...
                Box(
                    modifier = Modifier
                        .fillMaxSize()
                        .background(
                            brush = Brush.horizontalGradient(listOf(Teal40, TealGrey40)),
                            shape = RoundedCornerShape(16.dp)
                        ),
                    contentAlignment = Alignment.Center
                ) {
                    Text("Ana Sayfaya Dön", color = Color.White, fontWeight = FontWeight.Bold, fontSize = 16.sp)
                }
            }
